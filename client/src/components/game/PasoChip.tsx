...
export function PasoChip({ show, playerName, bonusPoints }: PasoChipProps) {
  ...
  return (
    <div className="paso-toast absolute left-1/2 -translate-x-1/2 flex items-center gap-2 bg-gradient-to-r from-red-900/90 to-red-800/85 border-2 border-red-500/50 rounded-full px-4 py-2 shadow-2xl shadow-red-900/30 backdrop-blur-sm pointer-events-none z-30 whitespace-nowrap">
